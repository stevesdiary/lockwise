...
export class CommunityPost extends Model<
  CommunityPostAttributes,
  CommunityPostCreationAttributes
> {
  @Column({
    type: DataType.UUID,
    primaryKey: true,
...
export type CommunityCommentCreationAttributes = Omit<
  CommunityCommentAttributes,
...
export class CommunityComment extends Model<
  CommunityCommentAttributes,
  CommunityCommentCreationAttributes
> {
  @Column({
    type: DataType.UUID,
    primaryKey: true,
